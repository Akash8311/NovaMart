  ...
  return (
      <>
          ...
          >
            ...
            <Link to="/MenProductDetails3" style={{ textDecoration: "none", color: "#777" }}>
              <div
                style={{
                  width: "100%",
                  height: "200px",
              ...
              >
                <img
                  src={isHovered ? "https://m.media-amazon.com/images/I/8133RQHrBuL._SY741_.jpg" : "https://m.media-amazon.com/images/I/61dFcpPdJkL._SY741_.jpg"}
                  alt="product"
                  style={{
                    width: "70%",
                    height: "100%",
