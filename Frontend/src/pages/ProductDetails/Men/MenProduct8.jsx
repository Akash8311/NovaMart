  ...
  return (
      <>
          ...
          >
            ...
            <Link to="/MenProductDetails8" style={{ textDecoration: "none", color: "#777" }}>
              <div
                style={{
                  width: "100%",
                  height: "200px",
              ...
              >
                <img
                  src={isHovered ? "https://m.media-amazon.com/images/I/71vSLpVgZpL._SX569_.jpg" : "https://m.media-amazon.com/images/I/71eUwDk8z+L._SX569_.jpg"}
                  alt="product"
                  style={{
                    width: "70%",
                    height: "100%",
            ...
            Half Seelves Regular Fit
              ...
              >
              Allen Solly Men Polo | Half Seelves Regular Fit | 60% Cotton with Banded Collar
              </p>
              ...
              >
                ⭐⭐⭐⭐⭐
                <span style={{ fontSize: "13px", color: "#555" }}>(1,321)</span>
              </div>
