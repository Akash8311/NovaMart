          ...
          {activeTab === "description" && (
            <div className="description">
              ...
              <p style={{ fontSize: "16px" }}>
                ...
                <span style={{ fontWeight: "bold" }}> Manufacturer:</span>{" "}
                NovaMart Brand - THREAD BUCKET STUDIO LLP, SACHIN PALSANA HIGHWAY, SACHIN 394230, Threadbucket Studio LLP, Surat - 394210
                <br />
...
export default GirlsProducReview3