...
import KidsProduct1 from "../ProductDetails/Kids/KidsProduct1";
    ...
    >
      ...
      >
        ...
        <div style={{ flex: "4 1 300px", width: "100%", minWidth: 0 }}>
          ...
          >
            <div className="productCard"><KidsProduct1	 view={viewType} /></div>
            <div className="productCard">  <KidProduct2 view={viewType} /></div>
            <div className="productCard">  <KidProduct3 view={viewType} /></div>
            <div className="productCard">  <KidProduct4 view={viewType} /></div>
            <div className="productCard">  <KidProduct5 view={viewType} /></div>
            <div className="productCard">  <KidProduct6 view={viewType}/></div>
            <div className="productCard">  <KidProduct7 view={viewType} /></div>
            <div className="productCard">  <KidProduct8 view={viewType} /></div>
            <div className="productCard">  <KidProduct9 view={viewType}/></div>
            <div className="productCard">  <KidProduct10 view={viewType} /></div>
            <div className="productCard">  <KidProduct11 view={viewType}/></div>
	          <div className="productCard">  <KidProduct12 view={viewType} /></div>
          </div>
